woi.directive('languagePopover', ['$compile', '$timeout', '$rootScope',  function($compile, $timeout, $rootScope){
    ...
    link:function(scope, element, attrs){
      ...
      // fix for intantiation before auth action
        if($rootScope.isUserLogged()) {
            ...
            $('div.qtip:visible').find('.qtip-content').css('overflow','visible');
          }
      });

      //qtipConfig.style.tip = false;
        // console.clear();
        console.log("%c %O", 'background:#eee', qtipConfig)
